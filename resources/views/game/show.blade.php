                        ...
                        <div class="bg-white dark:bg-gray-700 shadow-lg rounded-xl w-full p-4">
                            <div class="flex border-b w-full">
                                <button id="tab1Btn" onclick="activateTab(1)"
                                    class="tab-btn flex-1 py-2 text-center font-medium border-b-2 border-blue-500 text-blue-600 dark:border-blue-200 dark:text-blue-200">
                                    {{ $game->home_team->name }}
                                </button>
                            ...
                            @foreach ($teams as $index => $team)
                                <div id="tab{{ $index + 1 }}Content"
                                    class="tab-content p-4 {{ $index === 0 ? '' : 'hidden' }}">
                                    <div class="relative overflow-x-auto">
                                        <table
                                            ...
                                            <thead
                                                ...
                                                <tr>
                                                    <th scope="col" class="px-6 py-3">Giocatore</th>
